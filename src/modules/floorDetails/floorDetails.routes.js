...
router.post('/', FloorDetailsController.create.bind(FloorDetailsController)); // Create floor details
router.get('/', FloorDetailsController.find.bind(FloorDetailsController)); // Get all floor details
