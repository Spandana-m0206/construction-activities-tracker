...
const materialMetadataFields = {
    ...
    category: { type: String, enum: enumToArray(MaterialCategories), required: true }, // Enum for categories
    createdBy: { type: mongoose.Schema.Types.ObjectId, ref: 'User', required: true }, // Reference to User
    units: { type: String, enum: enumToArray(Units), required: true }, // Enum for units
